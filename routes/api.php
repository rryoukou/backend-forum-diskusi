...
use App\Http\Middleware\ChallengeApiCache; // <-- Middleware Cache ter-import aman

/**
 * --- Rute Publik (Tanpa Autentikasi) dengan Rate Limiter & Caching ---
 */
// Kita gabungkan middleware rate limiter dan cache di sini pakai array []
Route::middleware([ChallengeApiCache::class, 'production.limit'])->group(function () {
    
    Route::post('/register', [AuthController::class, 'register']);
    Route::post('/login', [AuthController::class, 'login']);

    // Eksplorasi Postingan, Kategori, dan Tag (Semua GET di sini otomatis ter-cache!)
    ...
    Route::middleware(['auth:sanctum', 'check.banned'])->group(function () {
        ...
        // Manajemen Postingan (CRUD) - POST/PUT/DELETE otomatis menghapus cache lama
    ...
    }); // Penutup auth:sanctum
}); // Penutup production.limit